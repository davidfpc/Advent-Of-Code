...
object Day15 {
    ...
    fun part1(input: List<Sensor>, row: Int = 2_000_000): Int {
    ...
    fun part2(input: List<Sensor>, maxValue: Int = 4_000_000): Long { // 4_000_000
    ...
    fun readInput(): List<Sensor> = File("inputFiles/day15.txt").readLines().map { input ->

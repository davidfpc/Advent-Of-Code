...
object Day9 {
    ...
    fun part1(input: List<Pair<Char, Int>>): Int = calcMoves(input, 2)

    fun part2(input: List<Pair<Char, Int>>): Int = calcMoves(input, 10)
    ...
    fun readInput(): List<Pair<Char, Int>> = File("inputFiles/day9.txt").readLines().map {

...
object Day11 {
    ...
    fun part1(input: List<Monkey>): Long = monkeyBusiness(input, 20) { it / 3L }
    ...
    fun readInput(): List<Monkey> = File("inputFiles/day11.txt").readText().split("\n\n").map {
        Monkey.parse(it)
    }
